...
pageespecie.myClass = BA.getDeviceClass ("b4a.example.pageespecie");
pageanimal.myClass = BA.getDeviceClass ("b4a.example.pageanimal");
especie.myClass = BA.getDeviceClass ("b4a.example.especie");
especierepository.myClass = BA.getDeviceClass ("b4a.example.especierepository");
animalrepository.myClass = BA.getDeviceClass ("b4a.example.animalrepository");
animal.myClass = BA.getDeviceClass ("b4a.example.animal");
